  ...
  return (
    <div className="min-h-screen p-12 bg-white flex flex-col">
      <Flex vertical>
        ...
        <h2 className='text-2xl font-semibold pb-8'>Team Module Progress</h2>
        <div className='flex justify-between p-8 mb-3 bg-[#E7E5FF] rounded-3xl'>
          <div className='flex flex-col items-center w-1/3'><span className='text-2xl font-extrabold'>1</span>Admin</div>
          <div className='flex flex-col items-center border-x-2 border-gray-300 w-1/3'><span className='text-2xl font-extrabold'>{usersProgress.length}</span>Team Members</div>
          <div className='flex flex-col items-center w-1/3'><span className='text-2xl font-extrabold'>100%</span>Happy</div>
        </div>
